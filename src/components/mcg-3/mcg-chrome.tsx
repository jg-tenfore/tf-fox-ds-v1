...
import { MCG_GREEN } from "@/components/instruction-3/instruction-catalog";
...
export const McgNav = () => {
    ...
    // Prototype 3 folds Clinics into Instruction, so a clinic page lights the Instruction tab.
