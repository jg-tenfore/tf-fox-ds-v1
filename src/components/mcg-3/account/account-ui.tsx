...
import { CREDIT_BALANCES, type CreditBalance, coachById, money } from "@/components/instruction-3/instruction-catalog";
import { reviewHref } from "@/components/mcg-3/academy/instructor-reviews";
