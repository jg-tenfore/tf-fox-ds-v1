...
import { GROUP_SERVICES, PRIVATE_SERVICES, money0, servicePrice } from "@/components/instruction-3/instruction-catalog";
                ...
                <section className="mt-12 grid gap-4 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]">
                    ...
                    <div className="flex flex-col gap-4 rounded-2xl bg-primary p-6 ring-1 ring-secondary ring-inset">
                        <div className="flex items-center justify-between gap-3">
                            ...
                            <Link href="/instruction/?formats=clinic,junior-camp,junior-league,op36" className="text-sm font-semibold text-brand-secondary hover:underline">
                                All clinics
                            </Link>
                        </div>
