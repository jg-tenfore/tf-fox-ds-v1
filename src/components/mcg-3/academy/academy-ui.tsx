...
import { servicesForCoach } from "@/components/instruction-3/instruction-catalog";
import { bookHref } from "./book-screen";
import { ACADEMY_COURSE_LOGOS, type AcademyInstructor, academyDisplayName, instructorPhoto } from "@/components/mcg-3/academy-roster";
