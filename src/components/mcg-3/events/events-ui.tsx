...
import { COURSE_LOGO, type LessonService } from "@/components/instruction-3/instruction-catalog";
import { CapacityMeter } from "@/components/instruction-3/instruction-ui";
import {
    CATEGORY_UI,
    COURSE_NAME,
    fmtDateShort,
