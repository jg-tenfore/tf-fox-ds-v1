            ...
            <McgPage>
                ...
                <section className="mt-14 border-t border-secondary pt-8">
                    ...
                    <p className="mt-6 text-sm text-tertiary">
                        ...
                        <Link href="/instruction/?formats=clinic,junior-camp,junior-league,op36" className="font-semibold text-brand-secondary transition duration-100 ease-linear hover:underline">
