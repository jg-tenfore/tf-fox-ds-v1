 ...
 */
import { PACKAGES, SUBSCRIPTIONS, serviceById, serviceFromPrice } from "@/components/instruction-3/instruction-catalog";
import type { ShopProduct } from "@/components/mcg-3/shop-catalog";
import type { RateClass } from "@/components/mcg-3/tee-times-data";
import { CART_18, MCG_COURSES, greenFee } from "@/components/mcg-3/tee-times-data";
