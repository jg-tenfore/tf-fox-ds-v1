...
import type { CartLine } from "@/components/mcg-3/session";
import { MD_TAX_RATE, SHOP_PRODUCTS } from "@/components/mcg-3/shop-catalog";
import { asset } from "@/utils/asset";

const KEY = "mcg-p3-shop-last-order-v1";
