...
import type { CartLine } from "@/components/mcg-2/session";
import { MD_TAX_RATE, SHOP_PRODUCTS } from "@/components/mcg-2/shop-catalog";
import { asset } from "@/utils/asset";

const KEY = "mcg-p2-shop-last-order-v1";
