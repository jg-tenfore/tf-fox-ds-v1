...
import { type ActivityItem, type CartLine, DEMO_USER, newId, useSession } from "@/components/mcg-2/session";
import { PICKUP_HOURS, PICKUP_READY, money } from "@/components/mcg-2/shop-catalog";
import { cx } from "@/utils/cx";
import { cartMultiBuySavings } from "@/components/mcg-2/registration-rules";
