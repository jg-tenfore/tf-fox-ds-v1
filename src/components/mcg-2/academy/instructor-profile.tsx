...
import { CapacityMeter, CourseChip, CreditPips, MenuItemRow, MetaLine, MicroLabel, SectionTitle, SlotButton } from "@/components/instruction-2/instruction-ui";
import { type AcademyInstructor, academyBanner, academyDisplayName, academyInstructor, academyLogo, instructorPhoto } from "@/components/mcg-2/academy-roster";
