...
import { LessonBookingFlow } from "@/components/instruction-2/lesson-booking-flow";
import { InstructionShellProvider } from "@/components/instruction-2/instruction-ui";
import { coachById, serviceById, PRIVATE_SERVICES } from "@/components/instruction-2/instruction-catalog";
import { McgHero, McgPage, McgShell } from "@/components/mcg-2/mcg-chrome";
import { SquareBookingFlow } from "@/components/mcg-2/instruction/square-booking";
import type { ReactNode } from "react";

const KEY = "mcg-p2-lesson-selection-v1";
        ...
        <McgPage width="5xl">
            <div className="flex flex-col items-center gap-4 rounded-2xl bg-primary px-6 py-14 text-center ring-1 ring-secondary ring-inset">
                ...
                <div className="flex flex-wrap justify-center gap-2.5">
                    ...
                    <Button size="lg" color="secondary" href="/instruction/?format=group">
...
export const LessonBookScreen = ({ selection: given }: LessonBookScreenProps = {}) => {
    ...
    if (service.kind === "private") {
        return <SquareBookingFlow service={service} coachId={selection.coachId} courseSlug={courseSlug} />;
    }
