...
import { CREDIT_BALANCES, type CreditBalance, coachById, money } from "@/components/instruction-2/instruction-catalog";
import { reviewHref } from "@/components/mcg-2/academy/instructor-reviews";
