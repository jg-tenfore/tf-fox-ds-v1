...
import { MCG_GREEN } from "@/components/instruction-2/instruction-catalog";
...
export const McgNav = () => {
    ...
    // Prototype 2 folds Clinics into Instruction, so a clinic page lights the Instruction tab.
    const isActive = (href: string) =>
        pathname === href || pathname.startsWith(`${href}/`) || (href === "/instruction" && (pathname === "/clinics" || pathname.startsWith("/clinics/")));
