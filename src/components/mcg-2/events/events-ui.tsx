...
import { COURSE_LOGO, type LessonService } from "@/components/instruction-2/instruction-catalog";
import { CapacityMeter } from "@/components/instruction-2/instruction-ui";
import {
    CATEGORY_UI,
    COURSE_NAME,
    fmtDateShort,
