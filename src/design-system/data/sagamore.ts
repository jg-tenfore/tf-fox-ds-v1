 ...
 *
 * Every story, screen, and edge case in this project draws from this file so
 * the whole environment reads like one coherent product. Sagamore is a
 * mid-Atlantic parkland course: an 18-hole championship layout plus a 9-hole
 * executive course. Nothing here is real.
 */
...
export interface TeeTime {
  id: string;
  courseId: string;
  /** ISO time, course local. */
  time: string;
  /** 24h label for display, e.g. "7:10 AM". */
  label: string;
  holes: Holes;
  rate: RateType;
...
export const COURSES: Course[] = [
  {
    ...
    yardage: 6841,
    description:
      'Sagamore’s flagship 18 — tree-lined fairways, a Redan 7th, and a closing stretch along Gwynns Run.',
  },
  {
    id: 'executive',
    name: 'The Executive',
    ...
    yardage: 2710,
    description:
      'A walkable 9-hole loop, ideal for a quick round after work or first lessons on the par 3s.',
  },
];
