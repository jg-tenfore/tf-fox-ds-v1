...
the named slots are not flexible enough.`},ref:{required:!1,tsType:{name:`Ref`,elements:[{name:`HTMLDivElement`}],raw:`Ref<HTMLDivElement>`},description:``},className:{required:!1,tsType:{name:`string`},description:``}},composes:[`Omit`]}})),k,A,j,M,N,P,F,I,L;e((()=>{k=r(),A=t(n()),o(),f(),y(),m(),g(),x(),O(),j={title:`Components/Layout & Structure/Filter Bars`,component:D,parameters:{layout:`padded`,docs:{description:{component:`The Filter Bar is the toolbar that sits above a tee sheet, member roster, or
...
stays greyscale to match the monochromatic Sagamore clubhouse theme.`}}},argTypes:{compact:{control:`boolean`},search:{control:!1},filters:{control:!1},actions:{control:!1},appliedTags:{control:!1}},args:{compact:!1}},M=[{id:`north`,label:`North Course`},{id:`south`,label:`South Course`},{id:`links`,label:`The Links`},{id:`par3`,label:`Par-3 Short Course`}],N={args:{search:(0,k.jsx)(h,{icon:s,placeholder:`Search the sheet…`,"aria-label":`Search`}),filters:(0,k.jsx)(_,{"aria-label":`Course`,placeholder:`All courses`,items:M,children:e=>(0,k.jsx)(_.Item,{id:e.id,children:e.label})}),actions:(0,k.jsx)(p,{color:`secondary`,iconLeading:a,children:`Filters`})}},P={render:e=>{let[t,n]=(0,A.useState)(new Set([`18`]));return(0,k.jsx)(D,{...e,search:(0,k.jsx)(h,{icon:s,placeholder:`Search members…`,"aria-label":`Search members`}),filters:(0,k.jsxs)(k.Fragment,{children:[(0,k.jsx)(_,{"aria-label":`Course`,placeholder:`All courses`,icon:c,items:M,children:e=>(0,k.jsx)(_.Item,{id:e.id,children:e.label})}),(0,k.jsxs)(b,{selectedKeys:t,onSelectionChange:e=>n(e),children:[(0,k.jsx)(v,{id:`9`,children:`9 holes`}),(0,k.jsx)(v,{id:`18`,children:`18 holes`})]})]}),actions:(0,k.jsx)(p,{color:`secondary`,iconLeading:a,children:`Filters`})})}},F={render:e=>{let[t,n]=(0,A.useState)([{id:`north`,label:`North Course`},{id:`morning`,label:`Before 10:00 AM`},{id:`members`,label:`Members only`},{id:`18`,label:`18 holes`}]),r=e=>n(t=>t.filter(t=>t.id!==e));return(0,k.jsx)(D,{...e,search:(0,k.jsx)(h,{icon:s,placeholder:`Search members…`,"aria-label":`Search members`}),filters:(0,k.jsx)(_,{"aria-label":`Course`,placeholder:`All courses`,icon:i,items:M,children:e=>(0,k.jsx)(_.Item,{id:e.id,children:e.label})}),actions:(0,k.jsx)(p,{color:`secondary`,iconLeading:a,children:`Filters`}),appliedTags:t.length>0&&(0,k.jsxs)(k.Fragment,{children:[(0,k.jsx)(S,{label:`Applied filters`,onRemove:e=>[...e].forEach(e=>r(String(e))),children:(0,k.jsx)(C,{items:t,className:`flex flex-wrap items-center gap-2`,children:e=>(0,k.jsx)(w,{id:e.id,onClose:r,children:e.label})})}),(0,k.jsx)(p,{color:`link-gray`,size:`sm`,onClick:()=>n([]),children:`Clear all`})]})})}},I={args:{compact:!0,search:(0,k.jsx)(h,{size:`sm`,icon:s,placeholder:`Search…`,"aria-label":`Search`}),filters:(0,k.jsx)(_,{size:`sm`,"aria-label":`Course`,placeholder:`All courses`,items:M,children:e=>(0,k.jsx)(_.Item,{id:e.id,children:e.label})}),actions:(0,k.jsx)(p,{size:`sm`,color:`secondary`,iconLeading:a,children:`Filters`})}},N.parameters={...N.parameters,docs:{...N.parameters?.docs,source:{originalSource:`{
  args: {
