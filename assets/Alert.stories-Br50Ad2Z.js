import{i as e}from"./preload-helper-tpQASj4C.js";import{d as t}from"./iframe-BbsIfxGP.js";import{Gr as n,Li as r,N as i,dn as a,ii as o,n as s,zi as c}from"./dist-Cq35TxdT.js";import{n as l,t as u}from"./button-xwWdqy2b.js";import{n as d,t as f}from"./alert-BUdFv4TS.js";var p,m,h,g,_,v,y,b;e((()=>{p=t(),s(),d(),l(),m={title:`Components/Feedback & Status/Alerts`,component:f,parameters:{layout:`centered`,docs:{description:{component:`Alerts surface time-sensitive course news to golfers — a confirmed tee time,
...
while success, warning, and error keep their hues so intent stays legible.`}}},argTypes:{color:{control:`select`,options:[`gray`,`brand`,`success`,`warning`,`error`]}}},h={args:{color:`success`,icon:o,title:`Tee time confirmed`,description:`You're booked on the Championship at 7:10 AM Saturday. A cart is included — arrive 20 minutes early.`},render:e=>(0,p.jsx)(`div`,{className:`w-[28rem]`,children:(0,p.jsx)(f,{...e})})},g={render:()=>(0,p.jsxs)(`div`,{className:`flex w-[28rem] flex-col gap-4`,children:[(0,p.jsx)(f,{color:`brand`,icon:a,title:`New booking window open`,description:`Members can now reserve tee times seven days ahead.`}),(0,p.jsx)(f,{color:`gray`,icon:o,title:`Round added to your calendar`,description:`We sent an invite to your inbox for Saturday morning.`}),(0,p.jsx)(f,{color:`success`,icon:n,title:`Tee time confirmed`,description:`You're on the Championship at 7:10 AM. See you at the first tee.`}),(0,p.jsx)(f,{color:`warning`,icon:i,title:`Course closed for aeration`,description:`The back nine is closed through Friday while greens recover. Front nine play continues as scheduled.`}),(0,p.jsx)(f,{color:`error`,icon:c,title:`Payment failed`,description:`We couldn't charge your card for the Saturday booking. Update your payment method to hold the slot.`})]})},_={render:()=>(0,p.jsx)(`div`,{className:`w-[28rem]`,children:(0,p.jsx)(f,{color:`warning`,icon:r,title:`Course closed for aeration`,description:`The Championship greens are being aerated this week. Want to play the Executive instead, or rebook for next weekend?`,onClose:()=>console.log(`alert dismissed`),actions:(0,p.jsxs)(p.Fragment,{children:[(0,p.jsx)(u,{size:`sm`,color:`link-gray`,children:`Dismiss`}),(0,p.jsx)(u,{size:`sm`,color:`link-color`,children:`View open tee times`})]})})})},v={render:()=>(0,p.jsx)(`div`,{className:`w-[28rem]`,children:(0,p.jsx)(f,{color:`error`,icon:c,title:`Payment failed`,description:`Your card was declined for the Saturday 7:10 AM booking. We'll hold the slot for 10 minutes while you retry.`,onClose:()=>console.log(`alert dismissed`),closeLabel:`Dismiss payment alert`})})},y={render:()=>(0,p.jsx)(`div`,{className:`w-[28rem]`,children:(0,p.jsx)(f,{icon:!1,color:`gray`,title:`Frost delay in effect`,description:`The first tee is held until 7:30 AM while the greens thaw. Grab a coffee in the clubhouse.`})})},h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  args: {
    color: "success",
