import{i as e}from"./preload-helper-tpQASj4C.js";import{n as t,t as n}from"./lesson-booking-flow-BhHNBPsX.js";var r,i,a,o,s,c,l,u,d,f,p,m,h,g,_,v,y,b,x;e((()=>{t(),r={title:`Instruction/Book a Lesson`,component:n,parameters:{layout:`fullscreen`,docs:{description:{component:`"Instruction / Book a Lesson" — Flow A of the MCG Academy build.
...
way round.`,...y.parameters?.docs?.description}}},b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`{
...
}`,...b.parameters?.docs?.source},description:{story:`Sign-up rules on a lesson. The junior private is for ages 7–17, checked against the
date of birth on the lesson date — the second golfer here is 19, so they're blocked
inline and Continue stays disabled until they're removed.`,...b.parameters?.docs?.description}}},x=[`Catalog`,`ChooseInstructor`,`PickATime`,`LessonDetails`,`CheckoutPayNow`,`CheckoutUseCredit`,`Confirmation`,`AnyAvailableInstructor`,`GroupProgram`,`ProgramFullWaitlist`,`NoAvailability`,`JoinTheWaitlist`,`FacilityCalendar`,`CrossCourseInstructor`,`MultiPersonLesson`,`JuniorLesson`,`JuniorLessonIneligible`]}))();export{d as AnyAvailableInstructor,i as Catalog,c as CheckoutPayNow,l as CheckoutUseCredit,a as ChooseInstructor,u as Confirmation,_ as CrossCourseInstructor,g as FacilityCalendar,f as GroupProgram,h as JoinTheWaitlist,y as JuniorLesson,b as JuniorLessonIneligible,s as LessonDetails,v as MultiPersonLesson,m as NoAvailability,o as PickATime,p as ProgramFullWaitlist,x as __namedExportsOrder,r as default};