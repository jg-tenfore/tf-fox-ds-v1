...
the named slots are not flexible enough.`},ref:{required:!1,tsType:{name:`Ref`,elements:[{name:`HTMLDivElement`}],raw:`Ref<HTMLDivElement>`},description:``},className:{required:!1,tsType:{name:`string`},description:``}},composes:[`Omit`]}})),k,A,j,M,N,P,F,I,L;e((()=>{k=r(),A=t(n()),c(),f(),y(),m(),g(),x(),O(),j={title:`Components/Layout & Structure/Filter Bars`,component:D,parameters:{layout:`padded`,docs:{description:{component:`The Filter Bar is the toolbar that sits above a tee sheet, member roster, or
