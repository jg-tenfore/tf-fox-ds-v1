import{i as e,l as t}from"./preload-helper-tpQASj4C.js";import{P as n,d as ee}from"./iframe-GkzZsI8Y.js";import{Er as te,Xr as ne,g as r,n as re,qt as i}from"./dist-5ici_Rh8.js";import{n as a,t as o}from"./button-UlumZzL3.js";import{r as ie,t as ae}from"./mcg-assets-CcJxDQjX.js";import{g as oe,h as s,v as c,x as se}from"./tenfore-chrome-saU2S3GT.js";import{B as ce,G as le,I as ue,M as l,N as u,O as de,P as fe,Q as d,c as f,d as p,f as pe,h as m,o as me,r as h,s as he,u as ge,v as g,x as _,y as v}from"./link-kFF9DAgC.js";import{C as y,D as b,E as x,O as _e,S as ve,T as S,_ as ye,a as C,b as w,c as T,d as E,f as D,i as O,l as k,m as A,n as j,o as M,p as N,r as P,s as be,t as xe,u as F,v as I,w as Se,x as Ce,y as L}from"./instruction-ui-CteRu0wO.js";var R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{R=ee(),re(),a(),ae(),oe(),ce(),se(),_e(),z=t(n()),B={title:`Instruction/Elements`,parameters:{layout:`fullscreen`,docs:{description:{component:`"Instruction / Elements" — the design-system layer under both Instruction flows.
...
and the exit guard.`}}}},V=({children:e})=>(0,R.jsx)(`div`,{className:`min-h-dvh bg-secondary px-6 py-10 sm:px-8`,style:s(g),children:(0,R.jsx)(`div`,{className:`mx-auto flex w-full max-w-6xl flex-col gap-12`,children:e})}),H=({title:e,note:t,children:n})=>(0,R.jsxs)(`section`,{className:`flex flex-col gap-4`,children:[(0,R.jsxs)(`div`,{className:`flex flex-col gap-1 border-b border-secondary pb-3`,children:[(0,R.jsx)(`h2`,{className:`text-lg font-semibold text-primary`,children:e}),(0,R.jsx)(`p`,{className:`max-w-3xl text-sm text-tertiary`,children:t})]}),n]}),U=l(`mike-kenny`),W=l(`doug-hamilton`),G=l(`dustin-stearns`),K=_.find(e=>e.id===`private-45`),q=()=>{let[e,t]=(0,z.useState)(`all`);return(0,R.jsx)(A,{options:he.map(e=>({id:e.id,label:e.label})),value:e,onChange:t})},J=()=>{let[e,t]=(0,z.useState)(630);return(0,R.jsx)(D,{slots:u(`doug-hamilton`,`laytonsville`,c),price:90,selected:e,onSelect:t})},Y=()=>{let[e,t]=(0,z.useState)(!1);return(0,R.jsxs)(`div`,{className:`rounded-2xl bg-primary p-5 ring-1 ring-secondary ring-inset`,children:[(0,R.jsx)(o,{size:`md`,color:`secondary`,onClick:()=>t(!0),children:`Show the exit guard`}),(0,R.jsx)(N,{open:e,onStay:()=>t(!1),onLeave:()=>t(!1)})]})},X={name:`All Elements`,render:()=>(0,R.jsxs)(V,{children:[(0,R.jsxs)(H,{title:`Service card`,note:`A private lesson and a scheduled program render as the same card, because structurally they are the same object with different capacity. This is what folding lessons into the clinics catalog buys you.`,children:[(0,R.jsx)(q,{}),(0,R.jsx)(`div`,{className:`mt-1 grid items-start gap-4 sm:grid-cols-2 xl:grid-cols-3`,children:[_[0],_[4],m[0],m[6]].map(e=>(0,R.jsx)(Se,{service:e},e.id))})]}),(0,R.jsx)(H,{title:`Capacity`,note:`Seats left in a scheduled program. Full becomes a waitlist prompt rather than a dead card — a flat “0 spots” tells the golfer nothing to do next.`,children:(0,R.jsx)(`div`,{className:`grid gap-4 rounded-2xl bg-primary p-5 ring-1 ring-secondary ring-inset sm:grid-cols-3`,children:[m[2],m[5],m[6]].map(e=>(0,R.jsxs)(`div`,{className:`flex flex-col gap-2`,children:[(0,R.jsx)(`span`,{className:`truncate text-sm font-semibold text-primary`,children:e.name}),(0,R.jsx)(P,{service:e})]},e.id))})}),(0,R.jsxs)(H,{title:`Instructor card`,note:`Priced for the selected service, so the per-instructor adjustment shows at the moment it matters. “Any available instructor” leads the list — the fix for landing on an empty calendar, applied before the golfer commits to a person.`,children:[(0,R.jsxs)(`div`,{className:`grid items-start gap-4 sm:grid-cols-2 xl:grid-cols-3`,children:[(0,R.jsx)(C,{coach:h,service:K,price:d(K,h,1),nextOpen:de(`laytonsville`,c).find(e=>e.status===`open`)?.label??`—`}),[U,W,G].map(e=>(0,R.jsx)(C,{coach:e,service:K,price:d(K,e,1),nextOpen:le(e.id,c)},e.id))]}),(0,R.jsxs)(`p`,{className:`text-sm text-tertiary`,children:[`Martin is `,(0,R.jsx)(`span`,{className:`font-semibold text-secondary`,children:`+$20`}),` on the academy rate, Dustin `,(0,R.jsx)(`span`,{className:`font-semibold text-secondary`,children:`−$20`}),`. One catalog, seven instructors — not seven catalogs.`]})]}),(0,R.jsx)(H,{title:`Lesson menu row`,note:`The academy menu priced for one instructor. Guardrails belong to the service — “Weekends only”, “9 AM – 12 PM” — so they narrow the calendar, not the other way round.`,children:(0,R.jsx)(`div`,{className:`flex flex-col gap-3`,children:_.slice(0,4).map(e=>(0,R.jsx)(ye,{service:e,coach:U,onBook:()=>{}},e.id))})}),(0,R.jsx)(H,{title:`Course identity`,note:`Nine MCG courses, each with its brand logo. Chips label a booking; the strip switches which course a cross-course instructor is teaching at.`,children:(0,R.jsxs)(`div`,{className:`flex flex-col gap-5`,children:[(0,R.jsx)(`div`,{className:`flex flex-wrap gap-2`,children:Object.keys(ge).map(e=>(0,R.jsx)(be,{slug:e,size:`md`},e))}),(0,R.jsx)(T,{slugs:W.courseSlugs,activeSlug:W.courseSlugs[0]})]})}),(0,R.jsx)(H,{title:`Availability`,note:`Open, booked and blocked all stay visible so a day reads honestly. Twenty cells in a flat grid is a wall; three labelled blocks is a schedule.`,children:(0,R.jsxs)(`div`,{className:`flex flex-col gap-6`,children:[(0,R.jsxs)(`div`,{className:`grid grid-cols-3 gap-2.5 sm:grid-cols-6`,children:[(0,R.jsx)(S,{label:`8:00 AM`,status:`open`,price:110}),(0,R.jsx)(S,{label:`8:30 AM`,status:`open`,price:110,selected:!0}),(0,R.jsx)(S,{label:`9:00 AM`,status:`open`,note:`Doug Hamilton`}),(0,R.jsx)(S,{label:`9:30 AM`,status:`booked`}),(0,R.jsx)(S,{label:`12:00 PM`,status:`blocked`,blockedReason:`Unavailable`}),(0,R.jsx)(S,{label:`1:00 PM`,status:`blocked`,blockedReason:`Not offered`})]}),(0,R.jsx)(`div`,{className:`rounded-2xl bg-primary p-5 ring-1 ring-secondary ring-inset`,children:(0,R.jsx)(J,{})}),(0,R.jsxs)(`div`,{children:[(0,R.jsx)(L,{children:`Facility calendar column`}),(0,R.jsx)(`div`,{className:`mt-2.5 flex gap-4 overflow-x-auto pb-2`,children:fe(`laytonsville`).map(e=>(0,R.jsx)(M,{coach:e,courseSlug:`laytonsville`,slots:u(e.id,`laytonsville`,c).filter(e=>e.minutes>=480&&e.minutes<=720)},e.id))})]})]})}),(0,R.jsx)(H,{title:`Credits`,note:`Pips read faster than “3 of 5”. The balance panel is the golfer's wallet view and, read the other way, the Academy's outstanding liability for that instructor.`,children:(0,R.jsxs)(`div`,{className:`flex flex-col gap-5`,children:[(0,R.jsx)(`div`,{className:`flex flex-wrap items-center gap-8 rounded-2xl bg-primary p-5 ring-1 ring-secondary ring-inset`,children:[{label:`Full`,n:5},{label:`Partly spent`,n:2},{label:`Used up`,n:0}].map(e=>(0,R.jsxs)(`div`,{className:`flex flex-col gap-2`,children:[(0,R.jsx)(L,{children:e.label}),(0,R.jsx)(E,{total:5,remaining:e.n})]},e.label))}),(0,R.jsxs)(`div`,{className:`grid items-start gap-4 lg:grid-cols-2`,children:[(0,R.jsx)(F,{balance:p[0],action:(0,R.jsx)(o,{size:`sm`,color:`primary`,children:`Book with these credits`})}),(0,R.jsx)(F,{balance:me}),(0,R.jsx)(F,{balance:p[1]}),(0,R.jsx)(F,{balance:pe[1],expired:!0})]})]})}),(0,R.jsx)(H,{title:`Policy as data`,note:`The howItWorks / included / restrictions triad from the Sagamore prototype. Expiry, transferability and refund terms stop being prose and become fields the Academy sets per package.`,children:(0,R.jsxs)(`div`,{className:`grid gap-6 rounded-2xl bg-primary p-6 ring-1 ring-secondary ring-inset lg:grid-cols-3`,children:[(0,R.jsx)(w,{title:`How it works`,items:v[0].howItWorks,tone:`good`}),(0,R.jsx)(w,{title:`What's included`,items:v[0].included,tone:`good`}),(0,R.jsx)(w,{title:`Restrictions`,items:v[0].restrictions,tone:`limit`})]})}),(0,R.jsx)(H,{title:`Checkout pieces`,note:`The Shop Checkout order-summary lines and the credit-applied callout, reused for lessons and for packages.`,children:(0,R.jsxs)(`div`,{className:`grid items-start gap-4 lg:grid-cols-2`,children:[(0,R.jsxs)(`div`,{className:`flex flex-col rounded-2xl bg-primary p-5 ring-1 ring-secondary ring-inset`,children:[(0,R.jsx)(b,{label:`45-Minute Private`,value:`$110.00`}),(0,R.jsx)(b,{label:`Lesson credit applied`,value:`−$110.00`}),(0,R.jsx)(b,{label:`Facility fee`,value:`$4.00`,muted:!0}),(0,R.jsx)(`div`,{className:`mt-2 border-t border-secondary pt-2.5`,children:(0,R.jsx)(b,{label:`Due now`,value:`$4.00`,strong:!0})})]}),(0,R.jsx)(ve,{children:`One credit applied — $110.00 covered. That leaves 4 lessons with Mike Kenny, good through December 31, 2026.`})]})}),(0,R.jsx)(H,{title:`Progress rail`,note:`Five stages for a private lesson, three for a program. Numbered because the steps really are a sequence.`,children:(0,R.jsxs)(`div`,{className:`flex flex-col gap-4 rounded-2xl bg-primary p-5 ring-1 ring-secondary ring-inset`,children:[[0,1,2,3,4].map(e=>(0,R.jsx)(x,{steps:[`Lesson`,`Instructor`,`Time`,`Details`,`Payment`],current:e},e)),(0,R.jsx)(`div`,{className:`border-t border-secondary pt-4`,children:(0,R.jsx)(x,{steps:[`Program`,`Details`,`Payment`],current:1})})]})}),(0,R.jsx)(H,{title:`Exit guard`,note:`A half-filled booking is worth confirming before it's thrown away — and the slot goes back to the calendar.`,children:(0,R.jsx)(Y,{})}),(0,R.jsx)(H,{title:`Typography, meta and badges`,note:`Section headings, icon meta lines, audience pills and credentials — the small type system both flows share.`,children:(0,R.jsxs)(`div`,{className:`grid items-start gap-4 lg:grid-cols-2`,children:[(0,R.jsxs)(`div`,{className:`flex flex-col gap-4 rounded-2xl bg-primary p-5 ring-1 ring-secondary ring-inset`,children:[(0,R.jsx)(y,{sub:`Supporting line under a section heading.`,children:`Section title`}),(0,R.jsxs)(`div`,{className:`flex flex-col gap-1.5`,children:[(0,R.jsx)(I,{icon:ne,children:`Fri, Jun 19, 2026`}),(0,R.jsx)(I,{icon:te,children:`10:30 AM · 45 min`}),(0,R.jsx)(I,{icon:i,children:`Falls Road`}),(0,R.jsx)(I,{icon:r,children:`1 golfer`})]}),(0,R.jsxs)(`div`,{className:`flex flex-wrap gap-2`,children:[(0,R.jsx)(j,{audience:`adult`}),(0,R.jsx)(j,{audience:`junior`}),(0,R.jsx)(j,{audience:`senior`})]}),(0,R.jsx)(Ce,{value:4.9,reviews:186})]}),(0,R.jsxs)(`div`,{className:`flex flex-col gap-4 rounded-2xl bg-primary p-5 ring-1 ring-secondary ring-inset`,children:[(0,R.jsx)(y,{children:`Credentials`}),(0,R.jsx)(k,{items:U.credentials}),(0,R.jsxs)(`div`,{className:`flex items-center gap-4 border-t border-secondary pt-4`,children:[f.slice(0,5).map(e=>(0,R.jsx)(O,{coach:e,size:`sm`},e.id)),(0,R.jsx)(O,{coach:h})]})]})]})})]})},Z={name:`Academy Hero`,render:()=>(0,R.jsx)(`div`,{style:s(g),children:(0,R.jsx)(xe,{title:`Golf lessons & clinics`,blurb:`Private lessons, playing lessons, multi-week clinics and junior camps across all nine MCG courses — in one place.`,right:(0,R.jsxs)(`div`,{className:`flex gap-3`,children:[(0,R.jsxs)(`div`,{className:`rounded-xl bg-secondary_subtle px-4 py-3 ring-1 ring-secondary ring-inset`,children:[(0,R.jsx)(L,{children:`Instructors`}),(0,R.jsx)(`p`,{className:`text-display-xs font-semibold text-primary tabular-nums`,children:f.length})]}),(0,R.jsxs)(`div`,{className:`rounded-xl bg-secondary_subtle px-4 py-3 ring-1 ring-secondary ring-inset`,children:[(0,R.jsx)(L,{children:`Courses`}),(0,R.jsx)(`p`,{className:`text-display-xs font-semibold text-primary tabular-nums`,children:ie.length})]})]})})})},Q={name:`Pricing Model`,render:()=>(0,R.jsx)(V,{children:(0,R.jsxs)(H,{title:`One academy menu, adjusted per instructor`,note:`The alternative to a private catalog per pro. A club publishes one lesson menu and marks its producers up; MCG's rate bands fall out of the adjustment. This is the direct answer to whether per-instructor pricing generalizes beyond a county system.`,children:[(0,R.jsx)(`div`,{className:`overflow-x-auto rounded-2xl ring-1 ring-secondary ring-inset`,children:(0,R.jsxs)(`table`,{className:`w-full min-w-[560px] bg-primary`,children:[(0,R.jsx)(`thead`,{children:(0,R.jsxs)(`tr`,{className:`border-b border-secondary bg-secondary_subtle`,children:[(0,R.jsx)(`th`,{className:`px-5 py-3 text-left text-xs font-semibold tracking-wide text-quaternary uppercase`,children:`Instructor`}),(0,R.jsx)(`th`,{className:`px-5 py-3 text-left text-xs font-semibold tracking-wide text-quaternary uppercase`,children:`Adjustment`}),_.slice(0,4).map(e=>(0,R.jsx)(`th`,{className:`px-5 py-3 text-right text-xs font-semibold tracking-wide text-quaternary uppercase`,children:e.name},e.id))]})}),(0,R.jsxs)(`tbody`,{className:`divide-y divide-secondary`,children:[(0,R.jsxs)(`tr`,{children:[(0,R.jsx)(`td`,{className:`px-5 py-3 text-sm font-semibold text-primary`,children:`Academy base`}),(0,R.jsx)(`td`,{className:`px-5 py-3 text-sm text-tertiary`,children:`—`}),_.slice(0,4).map(e=>(0,R.jsxs)(`td`,{className:`px-5 py-3 text-right text-sm text-tertiary tabular-nums`,children:[`$`,e.basePrice]},e.id))]}),f.map(e=>(0,R.jsxs)(`tr`,{children:[(0,R.jsx)(`td`,{className:`px-5 py-3 text-sm font-semibold text-primary`,children:e.name}),(0,R.jsx)(`td`,{className:`px-5 py-3 text-sm text-secondary tabular-nums`,children:e.priceAdj>0?`+$${e.priceAdj}`:e.priceAdj<0?`−$${Math.abs(e.priceAdj)}`:`$0`}),_.slice(0,4).map(t=>(0,R.jsxs)(`td`,{className:`px-5 py-3 text-right text-sm font-semibold text-primary tabular-nums`,children:[`$`,d(t,e,1)]},t.id))]},e.id))]})]})}),(0,R.jsxs)(`p`,{className:`text-sm text-tertiary`,children:[`Seven instructors × six services would be 42 hand-maintained menu items. Here it’s six services and seven numbers — and the “from” price on any card is `,`$${ue(`dustin-stearns`)}`,`, computed rather than typed.`]})]})})},X.parameters={...X.parameters,docs:{...X.parameters?.docs,source:{originalSource:`{
  name: "All Elements",
  render: () => <Sheet>
