import{i as e}from"./preload-helper-tpQASj4C.js";import{d as t}from"./iframe-DaSHUmTz.js";import{a as n,h as r,o as i,v as a}from"./blocks-Bid3X8G-.js";var o=e((()=>{r()}));function s(e){let t={code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...a(),...e.components};return(0,l.jsxs)(l.Fragment,{children:[(0,l.jsx)(n,{title:`Introduction`}),`
`,`
`,`
`,`
`,`
...
`,(0,l.jsxs)(t.p,{children:[`There are `,(0,l.jsx)(t.strong,{children:`three prototypes`}),`, each with its own screens, routes and session, so nothing done to one can change
another. `,(0,l.jsx)(t.strong,{children:`Prototype 1`}),` is what the `,(0,l.jsx)(t.strong,{children:`MCG Prototype`}),` stories below render. `,(0,l.jsx)(t.strong,{children:`Prototype 2`}),` combined Instruction
and Clinics and introduced the Square-style booking flow. `,(0,l.jsx)(t.strong,{children:`Prototype 3`}),` is the hybrid MCG asked for after
seeing both: one search step that takes courses, formats, dates, days and skill sets up front, Prototype 1's
time board and waitlist, and an account required before anything is booked.`]}),`
`,(0,l.jsxs)(t.p,{children:[`| | Screens | Routes | Local | Stories |
| --- | --- | --- | --- | --- |
| `,(0,l.jsx)(t.strong,{children:`Prototype 1`}),` | `,(0,l.jsx)(t.code,{children:`src/components/mcg`}),`, `,(0,l.jsx)(t.code,{children:`instruction`}),` | `,(0,l.jsx)(t.code,{children:`src/app`}),` | :3000 | `,(0,l.jsx)(t.strong,{children:`MCG Prototype`}),` |
| `,(0,l.jsx)(t.strong,{children:`Prototype 2`}),` | `,(0,l.jsx)(t.code,{children:`src/components/mcg-2`}),`, `,(0,l.jsx)(t.code,{children:`instruction-2`}),` | `,(0,l.jsx)(t.code,{children:`prototype-2/app`}),` | :3001 | linked only |
| `,(0,l.jsx)(t.strong,{children:`Prototype 3`}),` | `,(0,l.jsx)(t.code,{children:`src/components/mcg-3`}),`, `,(0,l.jsx)(t.code,{children:`instruction-3`}),` | `,(0,l.jsx)(t.code,{children:`prototype-3/app`}),` | :3002 | `,(0,l.jsx)(t.strong,{children:`MCG Prototype 3`}),` |`]}),`
`,(0,l.jsx)(t.p,{children:`Every tab below links to all three, so the same screen can be compared side by side.`}),`
`,(0,l.jsx)(m,{}),`
...
| `,(0,l.jsx)(t.strong,{children:`MCG Prototype 3`}),` | 15 | The hybrid: the one-step search with its filters, the instructor picker, Prototype 1's time board and waitlist, checkout with its sign-in gate, and the junior programs. |
...
npm run build:pages # all four, combined exactly as CI publishes them
`})}),`
...
`]})]})}function c(e={}){let{wrapper:t}={...a(),...e.components};return t?(0,l.jsx)(t,{...e,children:(0,l.jsx)(s,{...e})}):s(e)}var l,u,d,f,p,m;e((()=>{l=t(),o(),i(),u={1:{folder:`prototype`,port:3e3},2:{folder:`prototype-2`,port:3001},3:{folder:`prototype-3`,port:3002}},d=(e=1)=>{let{folder:t,port:n}=u[e];if(typeof window>`u`)return`https://jg-tenfore.github.io/tf-fox-ds-v1/${t}`;let{origin:r,pathname:i}=window.location,a=i.indexOf(`/iframe.html`),o=a>0?i.slice(0,a+1):`/`;return o===`/`?`http://localhost:${n}`:`${r}${o}${t}`},f=({path:e=`/`,which:t=1,children:n})=>(0,l.jsx)(`a`,{href:`${d(t)}${e}`,target:`_blank`,rel:`noreferrer`,style:{fontWeight:600},children:n}),p=[[`Home`,`/`,`Quick-book across all nine courses, the course portfolio with green fees, the Academy`],[`Tee Times`,`/tee-times/`,`All nine sheets intertwined into one board sorted by the clock, course pills, a resident-rate switch, per-course rate card → checkout → confirmation`],[`Shop`,`/shop/`,`A 53-SKU county pro shop (25 of them MCG crest merchandise) → product → cart → pickup-at-course checkout`],[`Events`,`/events/`,`27 county events — leagues, the County Amateur, junior tour qualifiers, charity scrambles`],[`Instruction`,`/instruction/`,`The MCG Academy — 23 real instructors across nine courses; pick a pro, pick their lesson, then time, details and payment`],[`Calendar`,`/calendar/`,`One month view across all nine courses — events, clinics and Academy programs`],[`Clinics`,`/clinics/`,`14 county clinic programs, filtered by level, age and course`],[`Grill`,`/grill/`,`Course grills and snack bars, with order-ahead for the turn`],[`Sign up`,`/signup/`,`Sign up → verify → account, plus sign in and password reset`],[`Account`,`/account/`,`Profile hub, activity history, lesson-credit wallet, settings`]],m=()=>(0,l.jsxs)(`table`,{style:{width:`100%`,borderCollapse:`collapse`,margin:`16px 0 0`},children:[(0,l.jsx)(`thead`,{children:(0,l.jsxs)(`tr`,{children:[(0,l.jsx)(`th`,{style:{textAlign:`left`,padding:`8px 12px 8px 0`,borderBottom:`1px solid #e4e7ec`,fontSize:13,color:`#667085`,width:140},children:`Tab`}),(0,l.jsx)(`th`,{style:{textAlign:`left`,padding:`8px 12px 8px 0`,borderBottom:`1px solid #e4e7ec`,fontSize:13,color:`#667085`,width:150},children:`Open in`}),(0,l.jsx)(`th`,{style:{textAlign:`left`,padding:`8px 0`,borderBottom:`1px solid #e4e7ec`,fontSize:13,color:`#667085`},children:`What's there`})]})}),(0,l.jsx)(`tbody`,{children:p.map(([e,t,n])=>(0,l.jsxs)(`tr`,{children:[(0,l.jsx)(`td`,{style:{padding:`10px 12px 10px 0`,borderBottom:`1px solid #f2f4f7`,verticalAlign:`top`,whiteSpace:`nowrap`,fontWeight:600,color:`#101828`},children:e}),(0,l.jsxs)(`td`,{style:{padding:`10px 12px 10px 0`,borderBottom:`1px solid #f2f4f7`,verticalAlign:`top`,whiteSpace:`nowrap`},children:[(0,l.jsx)(f,{path:t,children:`Prototype 1 ↗`}),(0,l.jsx)(`br`,{}),(0,l.jsx)(f,{path:t,which:2,children:`Prototype 2 ↗`}),(0,l.jsx)(`br`,{}),(0,l.jsx)(f,{path:t,which:3,children:`Prototype 3 ↗`})]}),(0,l.jsx)(`td`,{style:{padding:`10px 0`,borderBottom:`1px solid #f2f4f7`,fontSize:14,lineHeight:1.55,color:`#475467`},children:n})]},t))})]})}))();export{u as PROTOTYPES,f as Proto,p as TABS,m as TabTable,c as default,d as protoBase};