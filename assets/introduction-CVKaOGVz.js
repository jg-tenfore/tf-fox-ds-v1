import{i as e}from"./preload-helper-tpQASj4C.js";import{d as t}from"./iframe-GkzZsI8Y.js";import{a as n,h as r,o as i,v as a}from"./blocks-B1q8rH8b.js";var o=e((()=>{r()}));function s(e){let t={code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...a(),...e.components};return(0,l.jsxs)(l.Fragment,{children:[(0,l.jsx)(n,{title:`Introduction`}),`
`,`
`,`
`,`
`,`
...
combined into one tab, filtered by course and skill set, with a Square-style booking flow.`})})]})]}),`
...
`,(0,l.jsxs)(t.p,{children:[`There are two prototypes. `,(0,l.jsx)(t.strong,{children:`Prototype 1`}),` is the one the `,(0,l.jsx)(t.strong,{children:`MCG Prototype`}),` stories below render. `,(0,l.jsx)(t.strong,{children:`Prototype 2`}),`
started as an exact copy and is where independent changes go: its screens live in `,(0,l.jsx)(t.code,{children:`src/components/mcg-2`}),` and
`,(0,l.jsx)(t.code,{children:`src/components/instruction-2`}),`, its routes in `,(0,l.jsx)(t.code,{children:`prototype-2/app`}),`, and it keeps its own cart and session, so
nothing done to it can change Prototype 1. Prototype 2 is linked here but has no stories of its own.`]}),`
`,(0,l.jsx)(m,{}),`
...
npm run build:pages # all three, combined exactly as CI publishes them
`})}),`
