import{i as e,l as t}from"./preload-helper-tpQASj4C.js";import{P as n,d as r}from"./iframe-DaSHUmTz.js";import{$n as i,Nr as a,P as o,Ri as s,_r as c,n as l,yn as u}from"./dist-DEEhsJf6.js";import{A as d,D as f,E as ee,Lt as te,O as ne,On as p,T as re,j as m,k as h,t as ie}from"./exports-DC6NnTjn.js";import{n as ae,t as g}from"./cx-BIL-0sez.js";import{n as _,r as v,t as y}from"./tooltip-5YU1oWE1.js";import{i as b,n as x,t as S}from"./badges-C1FQziqh.js";import{r as C,t as w}from"./checkbox-CExeqTDN.js";import{n as T,t as E}from"./avatar-KN-HmCF8.js";import{n as D,t as O}from"./dropdown-CA5S4G5s.js";var k,A,j,M,N,P,F,I,L,R,z,B,V,H=e((()=>{k=r(),A=t(n()),l(),ie(),b(),C(),D(),v(),ae(),j=()=>(0,k.jsxs)(O.Root,{children:[(0,k.jsx)(O.DotsButton,{}),(0,k.jsx)(O.Popover,{className:`w-min`,children:(0,k.jsxs)(O.Menu,{children:[(0,k.jsx)(O.Item,{icon:i,children:(0,k.jsx)(`span`,{className:`pr-4`,children:`Edit`})}),(0,k.jsx)(O.Item,{icon:c,children:(0,k.jsx)(`span`,{className:`pr-4`,children:`Copy link`})}),(0,k.jsx)(O.Item,{icon:o,children:(0,k.jsx)(`span`,{className:`pr-4`,children:`Delete`})})]})})]}),M=(0,A.createContext)({size:`md`}),N=({children:e,className:t,size:n=`md`,...r})=>(0,k.jsx)(M.Provider,{value:{size:n},children:(0,k.jsx)(`div`,{...r,className:g(`overflow-hidden rounded-xl bg-primary shadow-xs ring-1 ring-secondary`,t),children:e})}),P=({title:e,badge:t,description:n,contentTrailing:r,className:i})=>{let{size:a}=(0,A.useContext)(M);return(0,k.jsxs)(`div`,{className:g(`relative flex flex-col items-start gap-4 border-b border-secondary bg-primary px-4 md:flex-row`,a===`sm`?`py-4 md:px-5`:`py-5 md:px-6`,i),children:[(0,k.jsxs)(`div`,{className:`flex flex-1 flex-col gap-0.5`,children:[(0,k.jsxs)(`div`,{className:`flex items-center gap-2`,children:[(0,k.jsx)(`h2`,{className:`text-md font-semibold text-primary`,children:e}),t?(0,A.isValidElement)(t)?t:(0,k.jsx)(S,{color:`gray`,size:`sm`,type:`modern`,children:t}):null]}),n&&(0,k.jsx)(`p`,{className:`text-sm text-tertiary`,children:n})]}),r]})},F=({className:e,size:t=`md`,...n})=>{let r=(0,A.useContext)(M);return(0,k.jsx)(M.Provider,{value:{size:r?.size??t},children:(0,k.jsx)(`div`,{className:`overflow-x-auto`,children:(0,k.jsx)(re,{className:t=>g(`w-full overflow-x-hidden`,typeof e==`function`?e(t):e),...n})})})},F.displayName=`Table`,I=({columns:e,children:t,bordered:n=!0,className:r,size:i,...a})=>{let o=(0,A.useContext)(M),{selectionBehavior:s,selectionMode:c}=m(),l=i??o.size;return(0,k.jsxs)(d,{...a,className:e=>g(`relative bg-secondary`,l===`sm`?`h-9`:`h-11`,n&&`[&>tr>th]:after:pointer-events-none [&>tr>th]:after:absolute [&>tr>th]:after:inset-x-0 [&>tr>th]:after:bottom-0 [&>tr>th]:after:h-px [&>tr>th]:after:bg-border-secondary [&>tr>th]:focus-visible:after:bg-transparent`,typeof r==`function`?r(e):r),children:[s===`toggle`&&(0,k.jsx)(f,{className:g(`relative py-2 pr-0 pl-4`,l===`sm`?`w-9 md:pl-5`:`w-11 md:pl-6`),children:c===`multiple`&&(0,k.jsx)(`div`,{className:`flex items-start`,children:(0,k.jsx)(w,{slot:`selection`,size:`md`})})}),(0,k.jsx)(p,{items:e,children:t})]})},I.displayName=`TableHeader`,L=({className:e,tooltip:t,label:n,children:r,...i})=>{let{selectionBehavior:o}=m();return(0,k.jsx)(f,{...i,className:t=>g(`relative p-0 px-6 py-2 outline-hidden focus-visible:z-1 focus-visible:ring-2 focus-visible:ring-focus-ring focus-visible:ring-offset-bg-primary focus-visible:ring-inset`,o===`toggle`&&`nth-2:pl-3`,t.allowsSorting&&`cursor-pointer`,typeof e==`function`?e(t):e),children:e=>(0,k.jsxs)(te,{className:`flex items-center gap-1`,children:[(0,k.jsxs)(`div`,{className:`flex items-center gap-1`,children:[n&&(0,k.jsx)(`span`,{className:`text-xs font-semibold whitespace-nowrap text-quaternary`,children:n}),typeof r==`function`?r(e):r]}),t&&(0,k.jsx)(y,{title:t,placement:`top`,children:(0,k.jsx)(_,{className:`cursor-pointer text-fg-quaternary transition duration-100 ease-linear hover:text-fg-quaternary_hover focus:text-fg-quaternary_hover`,children:(0,k.jsx)(u,{className:`size-4`})})}),e.allowsSorting&&(e.sortDirection?(0,k.jsx)(s,{className:g(`size-3 stroke-[3px] text-fg-quaternary`,e.sortDirection===`ascending`&&`rotate-180`)}):(0,k.jsx)(a,{size:12,strokeWidth:3,className:`text-fg-quaternary`}))]})})},L.displayName=`TableHead`,R=({columns:e,children:t,className:n,highlightSelectedRow:r=!0,size:i,...a})=>{let o=(0,A.useContext)(M),{selectionBehavior:s}=m(),c=i??o.size;return(0,k.jsxs)(ne,{...a,className:e=>g(`relative outline-focus-ring transition-colors after:pointer-events-none hover:bg-secondary focus-visible:outline-2 focus-visible:-outline-offset-2`,c===`sm`?`h-14`:`h-18`,r&&`selected:bg-secondary`,`[&>td]:after:absolute [&>td]:after:inset-x-0 [&>td]:after:bottom-0 [&>td]:after:h-px [&>td]:after:w-full [&>td]:after:bg-border-secondary last:[&>td]:after:hidden [&>td]:focus-visible:after:opacity-0 focus-visible:[&>td]:after:opacity-0`,typeof n==`function`?n(e):n),children:[s===`toggle`&&(0,k.jsx)(h,{className:g(`relative py-2 pr-0 pl-4`,c===`sm`?`md:pl-5`:`md:pl-6`),children:(0,k.jsx)(`div`,{className:`flex items-end`,children:(0,k.jsx)(w,{slot:`selection`,size:`md`})})}),(0,k.jsx)(p,{items:e,children:t})]})},R.displayName=`TableRow`,z=({className:e,children:t,size:n,...r})=>{let i=(0,A.useContext)(M),{selectionBehavior:a}=m(),o=n??i.size;return(0,k.jsx)(h,{...r,className:t=>g(`relative text-sm text-tertiary outline-focus-ring focus-visible:z-1 focus-visible:outline-2 focus-visible:-outline-offset-2`,o===`sm`&&`px-5 py-3`,o===`md`&&`px-6 py-4`,a===`toggle`&&`nth-2:pl-3`,typeof e==`function`?e(t):e),children:t})},z.displayName=`TableCell`,B={Root:N,Header:P},V=F,V.Body=ee,V.Cell=z,V.Head=L,V.Header=I,V.Row=R,j.__docgenInfo={description:``,methods:[],displayName:`TableRowActionsDropdown`},F.__docgenInfo={description:``,methods:[],displayName:`Table`,props:{size:{required:!1,tsType:{name:`union`,raw:`"sm" | "md"`,elements:[{name:`literal`,value:`"sm"`},{name:`literal`,value:`"md"`}]},description:``,defaultValue:{value:`"md"`,computed:!1}}},composes:[`AriaTableProps`,`Omit`]}})),U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{U=r(),W=t(n()),H(),T(),b(),G={title:`Components/Layout & Structure/Table`,component:V,parameters:{layout:`padded`,docs:{description:{component:`The morning tee sheet, rendered. Each row is a booked block on the first tee at
