import{i as e}from"./preload-helper-tpQASj4C.js";import{d as t}from"./iframe-BbsIfxGP.js";import{U as n,Yt as r,n as i,pt as a}from"./dist-Cq35TxdT.js";import{i as o,t as s}from"./input-Bf6n_f1W.js";var c,l,u,d,f,p,m,h,g,_,v,y,b,x;e((()=>{c=t(),i(),o(),l={title:`Components/Forms/Inputs/Input`,component:s,parameters:{layout:`centered`,docs:{description:{component:`Inputs collect everything a golfer types while booking — the email for the
confirmation, a promo code, searching the tee sheet. Minimal: hairline
border, ink focus ring, no fill.`}}},argTypes:{size:{control:`inline-radio`,options:[`sm`,`md`,`lg`]},isInvalid:{control:`boolean`},isDisabled:{control:`boolean`},label:{control:`text`},hint:{control:`text`},placeholder:{control:`text`}},args:{label:`Email address`,placeholder:`you@email.com`,hint:`We’ll send your tee-time confirmation here.`,size:`md`},decorators:[e=>(0,c.jsx)(`div`,{className:`w-80`,children:(0,c.jsx)(e,{})})]},u={},d={render:e=>(0,c.jsxs)(`div`,{className:`flex w-80 flex-col gap-4`,children:[(0,c.jsx)(s,{...e,size:`sm`,hint:void 0,label:`Small`}),(0,c.jsx)(s,{...e,size:`md`,hint:void 0,label:`Medium`}),(0,c.jsx)(s,{...e,size:`lg`,hint:void 0,label:`Large`})]}),decorators:[e=>(0,c.jsx)(e,{})]},f={args:{label:`Confirmation email`,icon:r,placeholder:`you@email.com`}},p={args:{label:`Member email`,tooltip:`Your tee-time confirmation and scorecard are sent here.`,placeholder:`you@email.com`}},m={args:{label:`Member name`,placeholder:`Olivia Rhye`,isRequired:!0,hint:`As it appears on your membership card.`}},h={args:{label:`Promo code`,icon:n,placeholder:`SAGAMORE20`,hint:`Members save 20% on twilight rounds.`}},g={args:{label:void 0,icon:a,placeholder:`Search tee times…`,hint:void 0}},_={args:{label:`Member portal password`,type:`password`,placeholder:`Enter your password`,hint:void 0}},v={args:{label:`Confirmation email`,type:`email`,icon:r,placeholder:`you@email.com`}},y={args:{label:`Confirmation email`,icon:r,placeholder:`you@email.com`,isDisabled:!0}},b={args:{label:`Promo code`,icon:n,placeholder:`Enter code`,isInvalid:!0,hint:`That code isn’t valid for this tee time.`}},u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`{}`,...u.parameters?.docs?.source}}},d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
